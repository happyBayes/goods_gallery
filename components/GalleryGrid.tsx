...
const GalleryGrid: React.FC<GalleryGridProps> = ({ artifacts, currentArtifactId, onSelect, onUpload, onDelete }) => {
          ...
          >
            ...
            >
              <div className="relative z-10 pr-6">
                ...
                <h3 className={`font-serif font-medium text-sm transition-colors truncate
            ...
            {currentArtifactId === art.id && (
              <div className="absolute left-0 top-0 bottom-0 w-1 bg-gallery-accent pointer-events-none" />
            )}
            ...
            <button
              ...
              className="absolute right-2 top-2 p-2 text-gray-500 hover:text-red-500 transition-colors opacity-0 group-hover:opacity-100 focus:opacity-100 z-20"
              title="Delete Model"
